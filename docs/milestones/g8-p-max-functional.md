...
| canal-4 attention_prior output | `attention_prior` (budget 1.5 — cumulative sum of attention prior components, hard cap on S4 enforced by `check_attention_bounded` in `kiki_oniric/dream/guards/attention.py`) | ✅ wired |
