...
\item
  ...
  abstraction during REM \citep{hobson2009rem, solms2021revising}.
\item
...
\citep{hobson2009rem, solms2021revising}. The mechanism is hypothesized
to be a generative-model-style sampling from a latent representation of
...
\citet{mcclelland1995complementary} (CLS) & Two-system hippocampus +
neocortex & Embedded in profile inclusion DR-4 (P\_min minimal vs P\_equ
richer) \\
\end{longtable}
}
